...
from src.modules.low_price_bull.low_price_bull_selector import LowPriceBullSelector
...
from src.modules.low_price_bull.low_price_bull_monitor import low_price_bull_monitor
from src.modules.low_price_bull.low_price_bull_service import low_price_bull_service
...
def display_low_price_bull():
    ...
    if st.session_state.get('show_low_price_monitor'):
        from src.modules.low_price_bull.low_price_bull_monitor_ui import display_monitor_panel
...
def display_stock_detail(row: pd.Series):
    ...
    from src.modules.low_price_bull.low_price_bull_monitor_ui import add_stock_to_monitor_button
