...
from src.modules.smart_monitor.smart_monitor_engine import SmartMonitorEngine
from src.modules.smart_monitor.smart_monitor_db import SmartMonitorDB
from src.core.config_manager import config_manager  # 使用主程序的配置管理器
...
def _render_task_kline_and_decisions(task: Dict, db: SmartMonitorDB, engine):
    ...
    Args:
        ...
        engine: 监控引擎实例
    """
    from src.modules.smart_monitor.smart_monitor_kline import SmartMonitorKline
    from src.modules.smart_monitor.smart_monitor_data import SmartMonitorDataFetcher
