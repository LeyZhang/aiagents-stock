...
logger = get_logger('main_force_ui')
# -*- coding: utf-8 -*-
"""
主力选股UI模块
"""
...
from src.modules.main_force.main_force_analysis import MainForceAnalyzer
from src.modules.main_force.main_force_pdf_generator import display_report_download_section
from src.modules.main_force.main_force_history_ui import display_batch_history
import pandas as pd
...
def run_main_force_batch_analysis():
    ...
    if start_analysis:
        ...
        save_error = None
        try:
            from src.modules.main_force.main_force_batch_db import batch_db
